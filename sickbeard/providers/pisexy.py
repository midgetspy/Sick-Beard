...
class PiSexyProvider(generic.TorrentProvider):
    ...
    def __init__(self):
        ...
        self.search_url = 'https://pisexy.me/sickbeard.php'
        self.rss_url = 'https://pisexy.me/sickbeard.php'
        self.download_url = 'http://pisexy.me/download.php?'

    def isEnabled(self):
        return sickbeard.PISEXY
    ...
    def _checkAuth(self):
        ...
        if not sickbeard.PISEXY_USERNAME or not sickbeard.PISEXY_PASSKEY:
    ...
    def _make_post_data_JSON(self, show=None, episode=None, season=None, search_term=None):
        ...
        post_data = {
            'username': sickbeard.PISEXY_USERNAME,
            'passkey': sickbeard.PISEXY_PASSKEY,
        }
...
class PiSexyCache(tvcache.TVCache):
    ...
    def __init__(self, provider):
        ...
        # only poll PiSexy every 15 minutes max
        self.minTime = 15
