...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                USE_PUSHBULLET, PUSHBULLET_USERKEY, PUSHBULLET_NOTIFY_ONDOWNLOAD, PUSHBULLET_NOTIFY_ONSNATCH, \
        ...
        PUSHBULLET_USERKEY = check_setting_str(CFG, 'Pushbullet', 'pushbullet_userkey', '')
...
def save_config():
    ...
    new_config['Pushbullet']['pushbullet_userkey'] = PUSHBULLET_USERKEY
