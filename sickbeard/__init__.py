...
DAILYTVTORRENTS_PREFER_TYPE = None
...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        DAILYTVTORRENTS_PREFER_TYPE = check_setting_str(CFG, 'DailyTvTorrents', 'dailytvtorrents_prefer_type', '')
...
def save_config():
    ...
    new_config['DailyTvTorrents']['dailytvtorrents_prefer_type'] = DAILYTVTORRENTS_PREFER_TYPE
