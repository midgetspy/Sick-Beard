...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, \
                ...
                COMING_EPS_LAYOUT, COMING_EPS_SORT, COMING_EPS_DISPLAY_PAUSED, METADATA_WDTV, METADATA_JRMC, IGNORE_WORDS
        ...
        # this is the normal codepath for metadata config
            ...
            METADATA_JRMC = check_setting_str(CFG, 'General', 'metadata_jrmc', '0|0|0|0|0|0')
            
            for cur_metadata_tuple in [(METADATA_XBMC, metadata.xbmc),
                                       (METADATA_MEDIABROWSER, metadata.mediabrowser),
                                       (METADATA_PS3, metadata.ps3),
                                       (METADATA_WDTV, metadata.wdtv),
                                       (METADATA_JRMC, metadata.jrmc),
                                       ]:
...
def save_config():
    ...
    new_config['General']['metadata_jrmc'] = metadata_provider_dict['JRMC'].get_config()
