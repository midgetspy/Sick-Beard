...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                USE_NZBS, USE_TORRENTS, NZB_METHOD, TORRENT_METHOD, NZB_DIR, DOWNLOAD_PROPERS, \
                SAB_USERNAME, SAB_PASSWORD, SAB_APIKEY, SAB_CATEGORY, SAB_HOST, \
                NZBGET_PASSWORD, NZBGET_CATEGORY, NZBGET_HOST, RTORRENT_CATEGORY, RTORRENT_URL, currentSearchScheduler, backlogSearchScheduler, \
        ...
        if TORRENT_METHOD not in ('blackhole', 'rtorrent'):
        ...
        CheckSection(CFG, 'rTorrent')
        RTORRENT_CATEGORY = check_setting_str(CFG, 'rTorrent', 'rtorrent_category', 'tv')
        RTORRENT_URL = check_setting_str(CFG, 'rTorrent', 'rtorrent_url', '')
...
def save_config():
    ...
    new_config['rTorrent'] = {}
    new_config['rTorrent']['rtorrent_category'] = RTORRENT_CATEGORY
    new_config['rTorrent']['rtorrent_url'] = RTORRENT_URL
