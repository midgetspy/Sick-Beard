...
from providers import ezrss, tvtorrents, torrentleech, btn, nzbsrus, newznab, womble, nzbx, omgwtfnzbs, hdbits, ninjacentral
...
NINJACENTRAL = False
NINJACENTRAL_UID = None
NINJACENTRAL_HASH = None
...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                NZBSRUS, NZBSRUS_UID, NZBSRUS_HASH, WOMBLE, NINJACENTRAL, NINJACENTRAL_UID, NINJACENTRAL_HASH, NZBX, NZBX_COMPLETION, OMGWTFNZBS, OMGWTFNZBS_USERNAME, OMGWTFNZBS_APIKEY, providerList, newznabProviderList, \
        ...
        CheckSection(CFG, 'Ninjacentral')
        NINJACENTRAL = bool(check_setting_int(CFG, 'Ninjacentral', 'ninjacentral', 0))
        NINJACENTRAL_UID = check_setting_str(CFG, 'Ninjacentral', 'ninjacentral_uid', '')
        NINJACENTRAL_HASH = check_setting_str(CFG, 'Ninjacentral', 'ninjacentral_hash', '')
...
def save_config():
    ...
    new_config['Ninjacentral'] = {}
    new_config['Ninjacentral']['ninjacentral'] = int(NINJACENTRAL)
    new_config['Ninjacentral']['ninjacentral_uid'] = NINJACENTRAL_UID
    new_config['Ninjacentral']['ninjacentral_hash'] = NINJACENTRAL_HASH
