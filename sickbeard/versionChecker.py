...
class GitUpdateManager(UpdateManager):
    ...
    def _check_github_for_update(self):
        ...
        # find newest commit
        for curCommit in gh.commits.forBranch(version.SICKBEARD_OWNER, version.SICKBEARD_PROJECT, version.SICKBEARD_VERSION):
    ...
    def set_newest_text(self):
        ...
        if self._newest_commit_hash:
            url = 'http://github.com/'+version.SICKBEARD_OWNER+'/'+version.SICKBEARD_PROJECT+'/compare/'+self._cur_commit_hash+'...'+self._newest_commit_hash
        else:
            url = 'http://github.com/'+version.SICKBEARD_OWNER+'/'+version.SICKBEARD_PROJECT+'/commits/'
