...
class TwilioNotifier:
    ...
    def _sendTwilio(self, msg, from_number, to_number, account_sid, auth_token):
        ...
        to_number: target phone number of the SMS; E.164 format (eg. +14031234567); multiple numbers can be specified comma-separated
        ...
        for target_number in to_number.split(","):
