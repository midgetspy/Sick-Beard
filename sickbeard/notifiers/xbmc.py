...
# TODO: switch over to using minidom
try:
...
class XBMCNotifier:
    ...
    def _notifyXBMC(self, message, title="Sick Beard", host=None, username=None, password=None, force=False):
