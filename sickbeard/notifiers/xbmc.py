...
class XBMCNotifier:
    ...
    sb_logo_url = 'https://raw.github.com/midgetspy/Sick-Beard/development/data/images/notifiers/xbmc-notify.png'
    sb_logo_url = 'http://zoggy.net/rsz_head.png' # TODO: temp placeholder, REMOVE once merged
