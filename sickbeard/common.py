...
class Quality:
    ...
    def nameQuality(name):
        ...
        if checkName(["(pdtv|hdtv|dsr|tvrip).(xvid|x264|h264|x265|h265)"], all) and not checkName(["(720|1080)[pi]"], all) and not checkName(["hr.ws.pdtv.x264"], any):
            return Quality.SDTV
        elif checkName(["webdl|webrip| web ", "xvid|h.?264|x264|h264|x265|h265"], all) and not checkName(["(720|1080)[pi]"], all):
            return Quality.SDTV
        ...
        elif checkName(["720p", "webdl|webrip| web "], all) or checkName(["720p", "itunes", "h.?264|x264|h264|x265|h265"], all):
            return Quality.HDWEBDL
        elif checkName(["1080p", "webdl|webrip| web "], all) or checkName(["1080p", "itunes", "h.?264|x264|h264|x265|h265"], all):
